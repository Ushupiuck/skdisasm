...
TwizHuffCopyMax	=	$0C
; ---------------------------------------------------------------------------
TwizHuffRet	= Nem_code_table				; $48 bytes
TwizHuffCopy	= ramaddr (TwizHuffRet+(TwizHuffRetMax*$04))	; $18 bytes
TwizVRAM	= ramaddr (TwizHuffCopy+(TwizHuffCopyMax*$02))	; $4 bytes
TwizSize	= ramaddr (TwizVRAM+$04)			; $2 bytes
; ---------------------------------------------------------------------------
TwizBufferSize	=	$1000
TwizBuffer	=	Kos_decomp_buffer			; $1000 bytes
; ---------------------------------------------------------------------------
